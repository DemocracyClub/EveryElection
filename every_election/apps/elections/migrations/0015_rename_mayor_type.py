...
def rename_mayor_type(apps, schema_editor):
    ...
    ElectionType.objects.filter(
        name="City mayor").update(name="Directly Elected Mayor")
...
def undo_rename_mayor_type(apps, schema_editor):
    ...
    ElectionType.objects.filter(
        name="Directly Elected Mayor").update(name="City mayor")

class Migration(migrations.Migration):

    dependencies = [
        ('elections', '0014_auto_20170107_1605'),
    ]

    operations = [
        migrations.RunPython(
            rename_mayor_type,
            undo_rename_mayor_type),
    ]
