...
class CreatePMtileForDivSetTests(TransactionTestCase):
    def setUp(self):
    ...
    def test_divset_not_found(self):
        ...
        call_command("create_pmtile_for_divset", 1000, stderr=stderr)
    ...
    def test_divset_has_no_divisions(self):
        ...
        stderr = StringIO()
        call_command(
            "create_pmtile_for_divset", self.divisionset.id, stderr=stderr
        )
