from sopn_publish_date import sopn_publish_date_for_id, sopn_publish_date
...
def test_publish_date_mayoral_group():
    try:
        sopn_publish_date_for_id('mayor.2016-05-05')
        fail("Should have thrown exception")
    except Exception as e:
...
def test_publish_date_scottish_local():
    ...
    publish_date = sopn_publish_date('scotland', datetime(2018, 12, 6))
...
def test_publish_date_northern_ireland_local():
    ...
    publish_date = sopn_publish_date('northern-ireland', datetime(2019, 5, 2))
